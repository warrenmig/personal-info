...
ScrollReveal({
  ...
  ScrollReveal().reveal('.skills-description, services-description, contact-card, .client-swiper, .contact-left, .contact-list', { delay: 100, origin: 'left'});

  ScrollReveal().reveal('.experience-card, .service-card, .education, .portfolio .img-card', { delay: 100, origin: 'bottom', interval: 50});
